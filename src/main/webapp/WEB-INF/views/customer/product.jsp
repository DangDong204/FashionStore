                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__left product__thumb nice-scroll">
                            <a class="pt active" href="#product-0">
                                <img src="${env }/${product.avatar}" alt="${product.name}">
                            </a>
                            <c:forEach var="img" items="${product.productImages}" varStatus="loop">
				                <a class="pt" href="#product-${loop.index + 1}">
				                    <img src="${env}/${img.path}" alt="${product.name}">
				                </a>
				            </c:forEach>
                        </div>
                        <div class="product__details__slider__content">
                            <div class="product__details__pic__slider owl-carousel">
                            	<img data-hash="product-0" class="product__big__img"
                     				src="${env}/${product.avatar}" alt="${product.name}">
                     				
                                <c:forEach var="img" items="${product.productImages}" varStatus="loop">
				                    <img data-hash="product-${loop.index + 1}" class="product__big__img"
				                         src="${env}/${img.path}" alt="${product.name}">
				                </c:forEach>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="product__details__tab">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">Hướng dẫn sử dụng</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                ...
                                <p>	+ Giặt máy ở nhiệt độ thường,không ngâm.<br>
									+ Không sử dụng hóa chất tẩy có chứa Clo.<br>
									+ Phơi ngay khi giặt xong.<br>
									+ Không sử dụng máy sấy.<br>
