...
<header id="header" class="header fixed-top d-flex align-items-center">
	...
	<div class="d-flex align-items-center justify-content-between">
		<a href="${env }/index" class="logo d-flex align-items-center"> <img
			src="${env }/administrator/img/logo.png" alt=""> <span
		...
		<ul class="d-flex align-items-center">
			...
			<!-- End Messages Icon -->
				...
				<ul
					...
					<li class="message-item"><a href="#"> <img
							src="${env }/administrator/img/messages-1.jpg" alt=""
					...
					<li class="message-item"><a href="#"> <img
							src="${env }/administrator/img/messages-2.jpg" alt=""
							class="rounded-circle">
							<div>
								<h4>Anna Nelson</h4>
								<p>Velit asperiores et ducimus soluta repudiandae labore
					...
					<li class="message-item"><a href="#"> <img
							src="${env }/administrator/img/messages-3.jpg" alt=""
							class="rounded-circle">
							<div>
								<h4>David Muldon</h4>
								<p>Velit asperiores et ducimus soluta repudiandae labore
			...
			<li class="nav-item dropdown pe-3"><a
				...
				data-bs-toggle="dropdown"> <img
					src="${env}/${loginedUser.avatar}" alt="Profile"
					class="rounded-circle"> <span
					class="d-none d-md-block dropdown-toggle ps-2">${loginedUser.name}</span>
			</a>
			<!-- End Profile Iamge Icon -->
				...
				<ul
					...
					<li class="dropdown-header">
						<h6> ${loginedUser.name}</h6> <span>Web Developer</span>
					</li>
					<li>
						<hr class="dropdown-divider">
					</li>
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="${env }/admin/error404"> <i class="bi bi-person"></i> <span>My
								Profile</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="${env }/admin/error404"> <i class="bi bi-gear"></i> <span>Account
								Settings</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="${env }/admin/error404"> <i class="bi bi-question-circle"></i> <span>Need
								Help?</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
